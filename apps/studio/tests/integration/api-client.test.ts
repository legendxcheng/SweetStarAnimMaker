...
describe("API Client", () => {
  ...
  it("preserves the public apiClient method surface", () => {
    expect(Object.keys(apiClient).sort()).toEqual([
      "approveAllImageFrames",
      ...
      "getFinalCut",
      "getImageFrame",
      "getMasterPlotReviewWorkspace",
      "getProjectDetail",
      "getShotScriptReviewWorkspace",
      "getStoryboardReviewWorkspace",
      "getTaskDetail",
      "getVideo",
      "listCharacterSheets",
      "listImages",
      ...
      "regenerateImages",
      "regenerateMasterPlot",
      "regenerateShotScript",
      "regenerateShotScriptSegment",
      "regenerateStoryboard",
      "regenerateUnfinishedImagePrompts",
