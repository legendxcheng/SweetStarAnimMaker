...
export const createSceneSheetsGenerateTaskResponseSchema = taskDetailResponseSchema;
export const createSceneSheetGenerateTaskResponseSchema = taskDetailResponseSchema;
