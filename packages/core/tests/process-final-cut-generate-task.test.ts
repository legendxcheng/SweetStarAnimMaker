...
describe("process final cut generate task use case", () => {
  it("sorts approved segment videos by segmentOrder before writing the concat manifest and final cut", async () => {
      ...
      listSegmentsByBatchId: vi.fn().mockResolvedValue([
        {
          ...
          referenceImages: [],
          referenceAudios: [],
          videoAssetPath: "videos/batches/video_batch_1/segments/scene_9__segment_3/current.mp4",
        ...
        },
        {
          ...
          referenceImages: [],
          referenceAudios: [],
          videoAssetPath: "videos/batches/video_batch_1/segments/scene_8__segment_1/current.mp4",
          thumbnailAssetPath: null,
          durationSec: 3,
          provider: "openai",
          model: "sora-2-all",
    ...
    expect(videoStorage.writeFinalCutManifest).toHaveBeenCalledWith({
      ...
      lines: [
        "file 'E:/SweetStarAnimMaker/.local-data/projects/proj_1-my-story/videos/batches/video_batch_1/segments/scene_8__segment_1/current.mp4'",
        "file 'E:/SweetStarAnimMaker/.local-data/projects/proj_1-my-story/videos/batches/video_batch_1/segments/scene_1__segment_2/current.mp4'",
        "file 'E:/SweetStarAnimMaker/.local-data/projects/proj_1-my-story/videos/batches/video_batch_1/segments/scene_9__segment_3/current.mp4'",
      ],
    });
