...
describe("process images generate task use case", () => {
  ...
  it("restores project status when image batch creation fails before setting the current batch", async () => {
    const taskRepository = {
      insert: vi.fn(),
      findById: vi.fn().mockResolvedValue({
        id: "task_20260324_images_insert_fail",
        projectId: "proj_20260324_ab12cd",
        type: "images_generate",
        status: "pending",
        queueName: "images-generate",
        storageDir:
          "projects/proj_20260324_ab12cd-my-story/tasks/task_20260324_images_insert_fail",
        inputRelPath: "tasks/task_20260324_images_insert_fail/input.json",
        outputRelPath: "tasks/task_20260324_images_insert_fail/output.json",
        logRelPath: "tasks/task_20260324_images_insert_fail/log.txt",
        errorMessage: null,
        createdAt: "2026-03-24T00:11:00.000Z",
        updatedAt: "2026-03-24T00:11:00.000Z",
        startedAt: null,
    ...
    const taskFileStorage = {
      createTaskArtifacts: vi.fn(),
      readTaskInput: vi.fn().mockResolvedValue({
        taskId: "task_20260324_images_insert_fail",
        projectId: "proj_20260324_ab12cd",
        taskType: "images_generate",
        sourceShotScriptId: "shot_script_v1",
      }),
    ...
    const shotScriptStorage = {
      ...
      readCurrentShotScriptVersion: vi.fn(),
    };
    const shotImageRepository = {
    ...
    await expect(
      useCase.execute({ taskId: "task_20260324_images_insert_fail" }),
