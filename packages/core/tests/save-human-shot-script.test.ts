...
describe("save current shot script use case", () => {
  it("throws when there is no current shot script to overwrite", async () => {
    const useCase = createSaveHumanShotScriptUseCase({
      projectRepository: {
        insert: vi.fn(),
  ...
  it("overwrites the current shot script and keeps the project in review", async () => {
